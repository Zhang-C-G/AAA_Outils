...
function Get-HotkeyDefs {
  return @(
    ...
    [ordered]@{ id='notes_overlay_parent_up'; label='笔记一级目录上移'; default='!Up'; group='notes_display'; group_label='笔记显示特有'; scope='notes_display' },
    [ordered]@{ id='notes_overlay_parent_down'; label='笔记一级目录下移'; default='!Down'; group='notes_display'; group_label='笔记显示特有'; scope='notes_display' },
