...
- `AI_DEVELOPMENT_PLAYBOOK.md`
  说明：AI 每个开发阶段开始前必须先读的总规范，明确所有模块统一采用两阶段开发法。

- `OVERLAY_STAGE2_GUIDE.md`
  说明：悬浮窗类能力的第二阶段专项清单。

- `NEW_MODE_CHECKLIST.md`
  说明：新增模块时的最小执行清单，按第一阶段、第二阶段拆分。

- `DOC_CREATION_GUIDE.md`
  说明：文档创建总指南，明确第一阶段文档、第二阶段能力说明、故障文档、AI 交接与日志文档应该怎么建。

- `文档低耦合与拆分规则.md`
  说明：约束文档职责边界、拆分触发条件与低耦合写法，防止单文档承载过多内容。

- `模块库总索引.md`
  说明：建立模块库机制，规定为什么复用、怎么选母版、什么时候不能硬套母版。

- `模块母版清单.md`
  说明：列出当前已稳定、值得复用的第一批模块母版。
